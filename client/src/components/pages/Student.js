                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2 text-muted"> CSE </h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title"> IMT </h5>
                            <h6 className="card-subtitle mb-2 text-muted"> IT & M.TECH </h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2 text-muted"> IT & MANAGEMENT </h6>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">Ph.D</h5>
                            <h6 className="card-subtitle mb-2 text-muted">Doctor Of Philosophy</h6>
